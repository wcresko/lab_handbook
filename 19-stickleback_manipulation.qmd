# Stickleback Manipulations - General {#sec-stickleback-manipulations}

![Willamette River - photo by Mark Currey](images/willamette_header.jpg)

## Live Fin Clipping of Stickleback {#sec-fin-clipping}

::: {.callout-note}
**Created:** April 06, 2010 by M Currey
:::

### Materials {#sec-fin-clipping-materials}
...
### Procedure {#sec-fin-clipping-procedure}
...
6. Once fish is revived and swimming upright, put fish into container back on the aquaculture system and add Melafix according to manufacturers recommendations

## Live Stickleback Alizarin Staining {#sec-live-alizarin-staining}

::: {.callout-note}
**Created:** 4/6/10 by M Currey
**Adapted from:** protocol by Bonnie Ullmann
:::

### Materials {#sec-alizarin-materials}

- MS-222 Anesthesia solution (see fish anesthesia and euthanasia SOP)
- Beakers of fish water
- Alizarin Red S (sodium alizarin sulfonate)

### Solutions {#sec-alizarin-solutions}
...
### Procedures {#sec-alizarin-procedures}

1. Stain 1-2 hours for larvae to overnight for adult fish in the dark. Rinse thoroughly with embryo medium. Can observe right away, but background continues to go down with time
...
## Embryo Injections {#sec-embryo-injections}
...
### Making the chambers {#sec-injection-chambers}
...
### Injecting {#sec-injection-procedure}
...
## Salinity Exposure {#sec-salinity-exposure}

::: {.callout-note}
**Created:** August 8, 2011 by Ann Petersen
:::

### Materials {#sec-salinity-materials}
...
### Procedure {#sec-salinity-procedure}

1. Follow stickleback crossing and rearing SOP to generate 100-200 fertilized embryos
2. Place petri dish with fertilized eggs and embryo medium (6ppt Instant Ocean) in common 20C incubator for 4 hours
...
::: {.callout-important}
Check water quality on two random tanks in each treatment once every two days before water has been changed. If ammonia and/or nitrite are detected then change water more frequently, check water quality daily, and denote this on checklist. **Ideal ammonia and nitrite levels are 0 ppm.**
:::

9. At designated time of interest up to 40 days post-fertilization, remove fish with a small clean net
...
## Intraperitoneal Colchicine Injection into Adult Stickleback {#sec-colchicine-injection}

::: {.callout-note}
**Created:** July 12, 2013 by Susie Bassham
:::

### Purpose {#sec-colchicine-purpose}
...
### Materials {#sec-colchicine-materials}
...
### Cortland's Salt Solution {#sec-cortlands-solution}
...
### Procedure {#sec-colchicine-procedure}
...
### Citations {#sec-colchicine-citations}
...
## EdU Labeling of Young Threespine Stickleback {#sec-edu-labeling}

::: {.callout-note}
**Created:** 10/22/2014 by Kristin Alligood
:::

### Purpose {#sec-edu-purpose}
...
### Procedure {#sec-edu-procedure}

#### EdU labeling and fixation {#sec-edu-labeling-fixation}
...
#### EdU detection {#sec-edu-detection}
...
3. Dilute 1:10 with nanopure water
4. Prepare the Click-iT reaction cocktail. Add reagents in the order listed:
...
## Perchlorate Exposure {#sec-perchlorate-exposure}

::: {.callout-note}
**Created:** 8/1/11 by Ann Petersen
:::

### Materials {#sec-perchlorate-materials}
...
### Procedure {#sec-perchlorate-procedure}

::: {.callout-warning}
Properly dispose of all perchlorate treated water into carboy marked "perchlorate water". Wear gloves and closed toe shoes.
:::
...
5. On a daily basis, check on development of embryos. Change water every day, making sure to replace with correct perchlorate treatment. Remove the dead or deformed embryos
6. At 8 dpf, after the embryos have hatched, move them to a 1 gallon glass jar full of the appropriate salinity water
...
## Fish Blood Collection {#sec-blood-collection}

::: {.callout-note}
**Created:** 8/1/11 by Ann Petersen
**Modified from:** Canada Department of Fisheries and Oceans Animal-User Training Template
:::

### Materials {#sec-blood-collection-materials}
...
### Human Safety Measures {#sec-blood-collection-safety}
...
### Procedure {#sec-blood-collection-procedure}

#### Tail ablation {#sec-tail-ablation}
...
6. Dispose of fish soma and tail in fish morgue as outlined in Stickleback SOP
